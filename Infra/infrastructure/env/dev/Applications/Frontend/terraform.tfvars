...
namesg           = "frontend-SG"
#---------launch template ---------------------#
name_prefix    = "autoscaling-frontend"
image_id       = "ami-06c4532923d4ba1ec"
instance_type2 = "t2.micro"
key_name2      = "Terraform"
resource_type  = "instance"
instance_name  = "frontend instances"
#---------------autoscaling group -------------------#
#availability_zones2       = "ap-northeast-1a"
max_size                  = "3"
min_size                  = "1"
name2                     = "frontend-autoscaling-group"
desired_capacity          = "2"
health_check_grace_period = "300"
health_check_type         = "EC2"
#-----------------autoscaling policy --------------#
name3              = "frontend_autoscaling_policy"
